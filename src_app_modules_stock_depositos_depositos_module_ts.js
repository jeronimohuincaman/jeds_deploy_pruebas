...
/* harmony import */ var _save_save_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./save/save.component */ 76397);
...
/* harmony import */ var _filter_menu_filter_menu_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./filter-menu/filter-menu.component */ 56319);
/* harmony import */ var _service_depositos_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../service/depositos.service */ 20040);
...
class DepositosComponent {
  constructor(_depositosService, _menuService, confirm, alert, dialogo, _searchService, router, _headerTextService) {
      ...
      if (res === 'confirmed') {
        this._depositosService.deleteDeposito(event.params.data.iddeposito).subscribe({
          ...
          error: error => {
            // Manejar el error
            console.error(error);
            alert("Este Depósito no puede eliminarse. Tiene elementos asociados.");
          }
        });
      }
    });
...
_class.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_11__["ɵɵdefineComponent"]({
  ...
  template: function DepositosComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      _angular_core__WEBPACK_IMPORTED_MODULE_11__["ɵɵlistener"]("click", function DepositosComponent_Template_button_click_3_listener() {
      ...
      _angular_core__WEBPACK_IMPORTED_MODULE_11__["ɵɵlistener"]("functionEmitter", function DepositosComponent_Template_app_tabla_dinamica_functionEmitter_8_listener($event) {
...
class SaveComponent {
  constructor(data, depositosService, alert, dialogRef) {
    this.data = data;
  ...
  newForm() {
    this.form = new _angular_forms__WEBPACK_IMPORTED_MODULE_2__.FormGroup({
      descripcion: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__.FormControl(this.deposito ? this.deposito.descripcion : '', _angular_forms__WEBPACK_IMPORTED_MODULE_2__.Validators.required),
      activo: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__.FormControl(this.deposito ? this.deposito?.activo ? 1 : 0 : '', _angular_forms__WEBPACK_IMPORTED_MODULE_2__.Validators.required)
    });
  }
  onSubmit() {
    if (!this.form.valid) {
...
_class.ɵfac = function SaveComponent_Factory(t) {
  return new (t || _class)(_angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdirectiveInject"](_angular_material_dialog__WEBPACK_IMPORTED_MODULE_4__.MAT_DIALOG_DATA), _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdirectiveInject"](_service_depositos_service__WEBPACK_IMPORTED_MODULE_0__.DepositosService), _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdirectiveInject"](app_shared_service_app_alert_service__WEBPACK_IMPORTED_MODULE_1__.AppAlertService), _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdirectiveInject"](_angular_material_dialog__WEBPACK_IMPORTED_MODULE_4__.MatDialogRef));
};
_class.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdefineComponent"]({
  type: _class,
...
/* harmony import */ var _components_filter_menu_filter_menu_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./components/filter-menu/filter-menu.component */ 56319);
...
(function () {
  (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_8__["ɵɵsetNgModuleScope"](DepositosModule, {
    declarations: [_components_depositos_component__WEBPACK_IMPORTED_MODULE_3__.DepositosComponent, _components_save_save_component__WEBPACK_IMPORTED_MODULE_4__.SaveComponent, _components_filter_menu_filter_menu_component__WEBPACK_IMPORTED_MODULE_7__.FilterMenuComponent],
