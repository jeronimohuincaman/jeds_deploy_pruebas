...
class SaveComponent {
  constructor(data, _tratamientosService, alert, dialogRef) {
    this.data = data;
  ...
  newForm() {
    this.form = new _angular_forms__WEBPACK_IMPORTED_MODULE_2__.FormGroup({
      nombre: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__.FormControl(this.tratamiento ? this.tratamiento.descripcion : '', _angular_forms__WEBPACK_IMPORTED_MODULE_2__.Validators.required),
      activo: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__.FormControl(this.tratamiento ? this.tratamiento.activo ? 1 : 0 : 0)
    });
  }
  onSubmit() {
    if (!this.form.valid) {
...
/* harmony import */ var _shared_service_app_menu_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @shared/service/app/menu.service */ 88802);
...
class TratamientosComponent {
  constructor(_tratamientosService, _searchService, _menuService, confirm, alert, dialogo) {
    this._tratamientosService = _tratamientosService;
...
TratamientosComponent.ɵfac = function TratamientosComponent_Factory(t) {
  return new (t || TratamientosComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_10__["ɵɵdirectiveInject"](_service_tratamientos_service__WEBPACK_IMPORTED_MODULE_4__.TratamientosService), _angular_core__WEBPACK_IMPORTED_MODULE_10__["ɵɵdirectiveInject"](app_layout_common_search_search_service__WEBPACK_IMPORTED_MODULE_5__.SearchService), _angular_core__WEBPACK_IMPORTED_MODULE_10__["ɵɵdirectiveInject"](_shared_service_app_menu_service__WEBPACK_IMPORTED_MODULE_6__.JedsMenuService), _angular_core__WEBPACK_IMPORTED_MODULE_10__["ɵɵdirectiveInject"](_fuse_services_confirmation__WEBPACK_IMPORTED_MODULE_7__.FuseConfirmationService), _angular_core__WEBPACK_IMPORTED_MODULE_10__["ɵɵdirectiveInject"](_shared_service_app_alert_service__WEBPACK_IMPORTED_MODULE_8__.AppAlertService), _angular_core__WEBPACK_IMPORTED_MODULE_10__["ɵɵdirectiveInject"](_angular_material_dialog__WEBPACK_IMPORTED_MODULE_14__.MatDialog));
};
TratamientosComponent.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_10__["ɵɵdefineComponent"]({
  ...
  template: function TratamientosComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      _angular_core__WEBPACK_IMPORTED_MODULE_10__["ɵɵlistener"]("click", function TratamientosComponent_Template_button_click_3_listener() {
      ...
      _angular_core__WEBPACK_IMPORTED_MODULE_10__["ɵɵlistener"]("functionEmitter", function TratamientosComponent_Template_app_tabla_dinamica_functionEmitter_8_listener($event) {
