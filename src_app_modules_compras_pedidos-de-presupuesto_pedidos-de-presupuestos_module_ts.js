...
class FilterMenuComponent {
  ...
  ngOnInit() {
    this.formFilters = new _angular_forms__WEBPACK_IMPORTED_MODULE_2__.FormGroup({
      proveedores: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__.FormControl('')
    });
...
_class.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdefineComponent"]({
  ...
  template: function FilterMenuComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵtext"](13, "Proveedores");
      _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵelementEnd"]();
...
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! rxjs */ 50655);
...
/* harmony import */ var _save_save_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./save/save.component */ 28329);
...
/* harmony import */ var _filter_menu_filter_menu_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./filter-menu/filter-menu.component */ 83179);
/* harmony import */ var _service_pedidos_de_presupuesto_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../service/pedidos-de-presupuesto.service */ 87933);
...
class PedidosDePresupuestoComponent {
  constructor(_pedidoDePresupuestosService, confirm, alert, dialogo, _searchService, menuService) {
  ...
  ngOnInit() {
    ...
    (0,rxjs__WEBPACK_IMPORTED_MODULE_12__.debounceTime)(750), (0,rxjs__WEBPACK_IMPORTED_MODULE_13__.distinctUntilChanged)()).subscribe(value => {
...
_class.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_10__["ɵɵdefineComponent"]({
  ...
  decls: 8,
  vars: 9,
  consts: [[1, "w-full", "flex", "flex-col"], [1, "m-2"], ["mat-icon-button", "", "type", "button", "matTooltip", "Crear pedido de presupuesto", 1, "mr-2", "ml-2", "bg-blue-500", "p-0", 3, "click"], ["save", ""], [1, "text-white"], [1, "pr-2", "pl-2"], [1, "relative", "bottom-10", "sm:bottom-0", "table-fixed", "sm:top-2", "z-0", "w-full", "m-0", 3, "cache", "columnsNames", "renderType", "columnsParams", "endpoint", "functions", "extraClasses", "FiltersLikes", "extraParams", "functionEmitter"]],
  template: function PedidosDePresupuestoComponent_Template(rf, ctx) {
    if (rf & 1) {
      _angular_core__WEBPACK_IMPORTED_MODULE_10__["ɵɵelementStart"](0, "div", 0)(1, "div", 1)(2, "button", 2, 3);
      _angular_core__WEBPACK_IMPORTED_MODULE_10__["ɵɵlistener"]("click", function PedidosDePresupuestoComponent_Template_button_click_2_listener() {
        return ctx.savePedidosDePresupuesto();
      });
      _angular_core__WEBPACK_IMPORTED_MODULE_10__["ɵɵelementStart"](4, "mat-icon", 4);
      _angular_core__WEBPACK_IMPORTED_MODULE_10__["ɵɵtext"](5, "add");
      _angular_core__WEBPACK_IMPORTED_MODULE_10__["ɵɵelementEnd"]()()();
      _angular_core__WEBPACK_IMPORTED_MODULE_10__["ɵɵelementStart"](6, "div", 5)(7, "app-tabla-dinamica", 6);
      _angular_core__WEBPACK_IMPORTED_MODULE_10__["ɵɵlistener"]("functionEmitter", function PedidosDePresupuestoComponent_Template_app_tabla_dinamica_functionEmitter_7_listener($event) {
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/core */ 61699);
/* harmony import */ var _service_pedidos_de_presupuesto_service__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../service/pedidos-de-presupuesto.service */ 87933);
...
class SaveComponent {
  constructor(data, _pedidosDePresupuestoService, alert, dialogRef) {
    this.data = data;
  ...
  newForm() {
    this.form = new _angular_forms__WEBPACK_IMPORTED_MODULE_2__.FormGroup({
      fecha: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__.FormControl(this.pedido_de_presupuesto ? this.pedido_de_presupuesto.fecha : '', _angular_forms__WEBPACK_IMPORTED_MODULE_2__.Validators.required),
      observaciones: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__.FormControl(this.pedido_de_presupuesto ? this.pedido_de_presupuesto.observaciones : '', _angular_forms__WEBPACK_IMPORTED_MODULE_2__.Validators.required)
    });
  }
  onSubmit() {
    if (!this.form.valid) {
...
_class.ɵfac = function SaveComponent_Factory(t) {
  return new (t || _class)(_angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdirectiveInject"](_angular_material_dialog__WEBPACK_IMPORTED_MODULE_4__.MAT_DIALOG_DATA), _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdirectiveInject"](_service_pedidos_de_presupuesto_service__WEBPACK_IMPORTED_MODULE_0__.PedidosDePresupuestoService), _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdirectiveInject"](app_shared_service_app_alert_service__WEBPACK_IMPORTED_MODULE_1__.AppAlertService), _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdirectiveInject"](_angular_material_dialog__WEBPACK_IMPORTED_MODULE_4__.MatDialogRef));
};
_class.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdefineComponent"]({
  type: _class,
...
/* harmony import */ var _components_pedidos_de_presupuesto_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/pedidos-de-presupuesto.component */ 18220);
/* harmony import */ var _components_save_save_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/save/save.component */ 28329);
/* harmony import */ var _service_pedidos_de_presupuesto_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./service/pedidos-de-presupuesto.service */ 87933);
...
/* harmony import */ var _components_filter_menu_filter_menu_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./components/filter-menu/filter-menu.component */ 83179);
...
_class = PedidosDePresupuestoModule;
_class.ɵfac = function PedidosDePresupuestoModule_Factory(t) {
  return new (t || _class)();
};
...
_class.ɵinj = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_8__["ɵɵdefineInjector"]({
  providers: [_service_pedidos_de_presupuesto_service__WEBPACK_IMPORTED_MODULE_5__.PedidosDePresupuestoService, _shared_service_app_menu_service__WEBPACK_IMPORTED_MODULE_1__.JedsMenuService, _shared_service_app_alert_service__WEBPACK_IMPORTED_MODULE_2__.AppAlertService],
...
_class = PedidosDePresupuestoService;
_class.ɵfac = function PedidosDePresupuestoService_Factory(t) {
