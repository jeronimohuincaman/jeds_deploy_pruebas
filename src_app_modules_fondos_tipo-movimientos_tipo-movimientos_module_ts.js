...
class SaveComponent {
  ...
  newForm() {
    this.form = new _angular_forms__WEBPACK_IMPORTED_MODULE_11__.FormGroup({
      nombre: new _angular_forms__WEBPACK_IMPORTED_MODULE_11__.FormControl(this.tipo_movimiento ? this.tipo_movimiento.descripcion : '', _angular_forms__WEBPACK_IMPORTED_MODULE_11__.Validators.required),
      activo: new _angular_forms__WEBPACK_IMPORTED_MODULE_11__.FormControl(this.tipo_movimiento ? this.tipo_movimiento.activo ? 1 : 0 : 1, _angular_forms__WEBPACK_IMPORTED_MODULE_11__.Validators.required)
    });
  }
  onSubmit() {
    if (!this.form.valid) {
