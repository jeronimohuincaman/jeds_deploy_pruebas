...
class ClientesComponent {
  constructor(_clientesService, _searchService, _menuService, confirm, alert, dialogo) {
...
ClientesComponent.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_10__["ɵɵdefineComponent"]({
  ...
  template: function ClientesComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      _angular_core__WEBPACK_IMPORTED_MODULE_10__["ɵɵlistener"]("click", function ClientesComponent_Template_button_click_3_listener() {
      ...
      _angular_core__WEBPACK_IMPORTED_MODULE_10__["ɵɵlistener"]("functionEmitter", function ClientesComponent_Template_app_tabla_dinamica_functionEmitter_8_listener($event) {
    ...
    if (rf & 2) {
      ...
      _angular_core__WEBPACK_IMPORTED_MODULE_10__["ɵɵproperty"]("cache", false)("columnsNames", ctx.headers)("renderType", "client")("columnsParams", ctx.column_params)("endpoint", ctx.env)("functions", ctx.funcionesObjeto)("extraClasses", "td.mat-cell border,td.mat-cell border-slate-400")("FiltersLikes", ctx.filtersLike);
    }
  },
