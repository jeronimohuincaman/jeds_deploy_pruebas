...
class SaveComponent {
  ...
  newForm() {
    this.form = new _angular_forms__WEBPACK_IMPORTED_MODULE_10__.FormGroup({
      descripcion: new _angular_forms__WEBPACK_IMPORTED_MODULE_10__.FormControl(this.rubro ? this.rubro.descripcion : '', _angular_forms__WEBPACK_IMPORTED_MODULE_10__.Validators.required),
      activo: new _angular_forms__WEBPACK_IMPORTED_MODULE_10__.FormControl(this.rubro ? this.rubro?.activo ? 1 : 0 : '', _angular_forms__WEBPACK_IMPORTED_MODULE_10__.Validators.required)
    });
  }
  onSubmit() {
    if (!this.form.valid) {
...
SaveComponent.ɵfac = function SaveComponent_Factory(t) {
  return new (t || SaveComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdirectiveInject"](_angular_material_dialog__WEBPACK_IMPORTED_MODULE_11__.MAT_DIALOG_DATA), _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdirectiveInject"](_service_rubros_service__WEBPACK_IMPORTED_MODULE_0__.RubrosService), _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdirectiveInject"](app_shared_service_app_alert_service__WEBPACK_IMPORTED_MODULE_1__.AppAlertService), _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdirectiveInject"](_angular_material_dialog__WEBPACK_IMPORTED_MODULE_11__.MatDialogRef));
};
