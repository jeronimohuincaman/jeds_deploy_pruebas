...
class TiposMovimientosComponent {
  constructor(_tipoDeMovimientosService, _menuService, confirm, alert, dialogo, _searchService, router, _headerTextService) {
...
TiposMovimientosComponent.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_11__["ɵɵdefineComponent"]({
  ...
  template: function TiposMovimientosComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      _angular_core__WEBPACK_IMPORTED_MODULE_11__["ɵɵlistener"]("click", function TiposMovimientosComponent_Template_button_click_3_listener() {
      ...
      _angular_core__WEBPACK_IMPORTED_MODULE_11__["ɵɵlistener"]("functionEmitter", function TiposMovimientosComponent_Template_app_tabla_dinamica_functionEmitter_8_listener($event) {
