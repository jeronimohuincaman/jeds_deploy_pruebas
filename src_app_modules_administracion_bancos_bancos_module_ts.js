...
class BancosComponent {
  constructor(_bancosService, _empresaService, _searchService, _menuService, confirm, alert, dialogo, router, _headerTextService) {
    ...
    this.env = environments_environment__WEBPACK_IMPORTED_MODULE_1__.environment.administracion.banco_token + '?';
...
BancosComponent.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_12__["ɵɵdefineComponent"]({
  ...
  template: function BancosComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      _angular_core__WEBPACK_IMPORTED_MODULE_12__["ɵɵlistener"]("click", function BancosComponent_Template_button_click_3_listener() {
      ...
      _angular_core__WEBPACK_IMPORTED_MODULE_12__["ɵɵtext"](9, "Agregar Banco");
      _angular_core__WEBPACK_IMPORTED_MODULE_12__["ɵɵelementEnd"]()()()()();
      _angular_core__WEBPACK_IMPORTED_MODULE_12__["ɵɵelementStart"](10, "div", 9)(11, "app-tabla-dinamica", 10);
      _angular_core__WEBPACK_IMPORTED_MODULE_12__["ɵɵlistener"]("functionEmitter", function BancosComponent_Template_app_tabla_dinamica_functionEmitter_11_listener($event) {
...
class SaveComponent {
  constructor(data, _bancosService, _empresaService, alert, dialogRef) {
    this.data = data;
    this._bancosService = _bancosService;
    this._empresaService = _empresaService;
    this.alert = alert;
  ...
  newForm() {
    this.form = new _angular_forms__WEBPACK_IMPORTED_MODULE_11__.FormGroup({
      nombre: new _angular_forms__WEBPACK_IMPORTED_MODULE_11__.FormControl(this.banco ? this.banco.descripcion : '', _angular_forms__WEBPACK_IMPORTED_MODULE_11__.Validators.required),
      activo: new _angular_forms__WEBPACK_IMPORTED_MODULE_11__.FormControl(this.banco ? this.banco.activo ? 1 : 0 : 1) // Se hace esa condicional porque en el componente
