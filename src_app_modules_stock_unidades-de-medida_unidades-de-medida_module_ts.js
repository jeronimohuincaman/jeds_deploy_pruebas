...
class SaveComponent {
  constructor(data, unidadMedidaService, _empresaService, alert, dialogRef) {
    this.data = data;
  ...
  newForm() {
    this.form = new _angular_forms__WEBPACK_IMPORTED_MODULE_11__.FormGroup({
      descripcion: new _angular_forms__WEBPACK_IMPORTED_MODULE_11__.FormControl(this.unidadMedida ? this.unidadMedida.descripcion : '', _angular_forms__WEBPACK_IMPORTED_MODULE_11__.Validators.required),
      activo: new _angular_forms__WEBPACK_IMPORTED_MODULE_11__.FormControl(this.unidadMedida ? this.unidadMedida?.activo ? 1 : 0 : '')
    });
  }
  onSubmit() {
    if (!this.form.valid) {
...
class UnidadesDeMedidaComponent {
  constructor(_unidadesDeMedidaService, _empresaService, confirm, alert, dialogo, _searchService, _menuService, _headerTextService, router) {
...
UnidadesDeMedidaComponent.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_12__["ɵɵdefineComponent"]({
  ...
  template: function UnidadesDeMedidaComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      _angular_core__WEBPACK_IMPORTED_MODULE_12__["ɵɵlistener"]("click", function UnidadesDeMedidaComponent_Template_button_click_3_listener() {
      ...
      _angular_core__WEBPACK_IMPORTED_MODULE_12__["ɵɵtext"](9, "Agregar Unidad de medida");
      _angular_core__WEBPACK_IMPORTED_MODULE_12__["ɵɵelementEnd"]()()()()();
      _angular_core__WEBPACK_IMPORTED_MODULE_12__["ɵɵelementStart"](10, "div", 9)(11, "app-tabla-dinamica", 10);
      _angular_core__WEBPACK_IMPORTED_MODULE_12__["ɵɵlistener"]("functionEmitter", function UnidadesDeMedidaComponent_Template_app_tabla_dinamica_functionEmitter_11_listener($event) {
