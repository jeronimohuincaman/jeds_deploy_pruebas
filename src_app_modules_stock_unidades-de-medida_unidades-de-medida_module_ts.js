...
class SaveComponent {
  ...
  newForm() {
    this.form = new _angular_forms__WEBPACK_IMPORTED_MODULE_10__.FormGroup({
      descripcion: new _angular_forms__WEBPACK_IMPORTED_MODULE_10__.FormControl(this.unidadMedida ? this.unidadMedida.descripcion : '', _angular_forms__WEBPACK_IMPORTED_MODULE_10__.Validators.required),
      activo: new _angular_forms__WEBPACK_IMPORTED_MODULE_10__.FormControl(this.unidadMedida ? this.unidadMedida?.activo ? 1 : 0 : '')
    });
  }
  onSubmit() {
    if (!this.form.valid) {
...
SaveComponent.ɵfac = function SaveComponent_Factory(t) {
  return new (t || SaveComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdirectiveInject"](_angular_material_dialog__WEBPACK_IMPORTED_MODULE_11__.MAT_DIALOG_DATA), _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdirectiveInject"](_service_unidades_de_medida_service__WEBPACK_IMPORTED_MODULE_0__.UnidadesDeMedidaService), _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdirectiveInject"](app_shared_service_app_alert_service__WEBPACK_IMPORTED_MODULE_1__.AppAlertService), _angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdirectiveInject"](_angular_material_dialog__WEBPACK_IMPORTED_MODULE_11__.MatDialogRef));
};
...
class UnidadesDeMedidaComponent {
  constructor(_unidadesDeMedidaService, confirm, alert, dialogo, _searchService, _menuService, _headerTextService, router) {
...
UnidadesDeMedidaComponent.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_11__["ɵɵdefineComponent"]({
  ...
  template: function UnidadesDeMedidaComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      _angular_core__WEBPACK_IMPORTED_MODULE_11__["ɵɵlistener"]("click", function UnidadesDeMedidaComponent_Template_button_click_3_listener() {
      ...
      _angular_core__WEBPACK_IMPORTED_MODULE_11__["ɵɵlistener"]("functionEmitter", function UnidadesDeMedidaComponent_Template_app_tabla_dinamica_functionEmitter_8_listener($event) {
...
UnidadesDeMedidaModule.ɵinj = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_8__["ɵɵdefineInjector"]({
  providers: [_service_unidades_de_medida_service__WEBPACK_IMPORTED_MODULE_1__.UnidadesDeMedidaService, _shared_service_app_jeds_menu_service__WEBPACK_IMPORTED_MODULE_4__.JedsMenuService, _shared_service_app_alert_service__WEBPACK_IMPORTED_MODULE_5__.AppAlertService],
